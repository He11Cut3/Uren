...
namespace Hells_Tire.Migrations
{
    ...
    [Migration("20231126162232_InitialV3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hells_Tire.Models.CartItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Hells_Tire.Models.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Hells_Tire.Models.OrderItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Hells_Tire.Models.CartItem", b =>
                {
                    b.HasOne("Hells_Tire.Models.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId");

                    b.HasOne("Hells_Tire.Models.AppUser", "User")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Hells_Tire.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("Hells_Tire.Models.HellsTireProduct", "Product")
                        .WithMany()
